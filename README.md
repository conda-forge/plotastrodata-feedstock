...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/plotastrodata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/plotastrodata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add plotastrodata
# for installing globally
pixi global install plotastrodata
```
...
It is possible to list all of the versions of `plotastrodata` available on your platform:
...
```
pixi search plotastrodata --channel conda-forge
```
